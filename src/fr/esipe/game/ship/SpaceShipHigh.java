 ...
 *
 */
public class SpaceShipHigh extends SpaceShip {
	public SpaceShipHigh(World world, Track track, boolean isEnemy, Context context) {
		super(Utils.createImage(context, R.drawable.spaceship3), "spaceship low", isEnemy, false, 10, world);
