 ...
 *
 */
public class SpaceShipLow extends SpaceShip {
	public SpaceShipLow(World world, Track track, boolean isEnemy, Context context) {
		super(Utils.createImage(context, R.drawable.spaceship1), "spaceship low", isEnemy, false, 10, world);
